...
module.exports = {
  ...
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    if (!phoneNumber || !message) {
      return sendMessage(senderId, { text: '❌ 𝗨𝘀𝗮𝗴𝗲: 𝗳𝗿𝗲𝗲𝘀𝗺𝘀 𝗽𝗵𝗼ន 𝗻𝘂𝗺𝗯𝗲𝗿 𝗺𝗲𝘀𝘀𝗮𝗴𝗲' }, pageAccessToken);
    }
    ...
    try {
      ...
      sendMessage(senderId, { text: '❌ 𝗙𝗮𝗶𝗹𝗲드 𝘁𝗼 𝘀𝗲𝗻𝗱 𝘁𝗵𝗲 𝗺𝗲𝘀𝘀𝗮𝗴𝗲.' }, pageAccessToken);
    }
  }
};
